...
export const translations = {
  'zh-CN': {
    ...
    business: {
      ...
      quickActions: ['我想做一个电商网站', '咨询 AI 自动化方案', '预约会议', '询问报价范围', '获取联系方式'],
  ...
  'en-US': {
    ...
    business: {
      ...
      quickActions: ['I need an E-commerce site', 'Consult on AI Automation', 'Schedule a meeting', 'Price range inquiry', 'Get Contact Info'],
